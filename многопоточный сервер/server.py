...
commands = ['Показ логинов', 'Очистка логинов', 'Очистка файла, хранящего идентификации', 'Остановка работы сервера']
commands_short = ['Show_logs','Del_logs','Del_ID','Stop_server']
...
def serv_work(sock):
    ...
    while True:
        ...
        elif 'Show_logs' == command:
            with open('log.log', 'r') as file:
                for raw in file:
                    print(raw)
        elif 'Del_logs' == command:
